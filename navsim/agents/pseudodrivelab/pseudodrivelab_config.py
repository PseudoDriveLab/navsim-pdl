...
@dataclass
class PseudodrivelabConfig:
    """Global Pseudolab config."""

    image_architecture: str = "resnet34"
    lidar_architecture: str = "resnet34"

    latent: bool = False
    latent_rad_thresh: float = 3 * np.pi / 4    # EDITTED: Pseudolab by Hyeongkyun Kim. -135 ~ 135 deg
    ...
    camera_width: int = 2304    # EDITTED: Pseudolab by Hyeongkyun Kim
    camera_height: int = 256
    lidar_resolution_width = 256
    lidar_resolution_height = 256

    img_vert_anchors: int = 256 // 32
    img_horz_anchors: int = 2304 // 32      # EDITTED: Pseudolab by Hyeongkyun Kim
    ...
    # NOTE: by Kim. Downstream task from BEV Branch
    detect_boxes = True
    use_bev_semantic = True
    # NOTE: by Kim. Downstream task from Image Branch
    use_semantic = False
    use_depth = False
    ...
    # Transformer
    tf_d_model: int = 256
    tf_d_ffn: int = 2304        # EDITTED: Pseudolab by Hyeongkyun Kim
    tf_num_layers: int = 3
    tf_num_head: int = 8
    ...
    bev_pixel_height: int = lidar_resolution_height # EDITTED: Pseudolab by Kim. *_height // 2 -> *_height
    bev_pixel_size: float = 0.25

    # NOTE: Pseudolab by Kim : Used for making 'bev_feature_upscale' in *_model.py
    num_bev_classes = 7
