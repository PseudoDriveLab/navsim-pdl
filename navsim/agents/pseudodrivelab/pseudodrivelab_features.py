...
class PseudodrivelabFeatureBuilder(AbstractFeatureBuilder):
    """Input feature builder for Pseudolab."""

    def __init__(self, config: PseudodrivelabConfig):
        """
    ...
    def _get_camera_feature(self, agent_input: AgentInput) -> torch.Tensor:
        ...
        # EDITTED: Pseudolab v0.2 by Hyeongkyun Kim
        # Crop to ensure 9:1 aspect ratio                  
        l2 = cameras.cam_l2.image[28:-28, :-1000]           
        l1 = cameras.cam_l1.image[28:-28, :-612]            
        l0 = cameras.cam_l0.image[28:-28, :-500]            
        f0 = cameras.cam_f0.image[28:-28]                   
        r0 = cameras.cam_r0.image[28:-28, 500:]             
        r1 = cameras.cam_r1.image[28:-28, 612:]             
        r2 = cameras.cam_r2.image[28:-28, 1000:]            

        # stitch all images
        stitched_image = np.concatenate([l2, l1, l0, f0, r0, r1, r2], axis=1)
        resized_image = cv2.resize(stitched_image, (256 * 9, 256))
    ...
    def _get_lidar_feature(self, agent_input: AgentInput) -> torch.Tensor:
        """
        Compute LiDAR feature as 2D histogram, according to Pseudolab
        :param agent_input: input dataclass
...
class PseudodrivelabTargetBuilder(AbstractTargetBuilder):
    """Output target builder for Pseudolab."""
    ...
    def _compute_agent_targets(self, annotations: Annotations) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        def _xy_in_lidar(x: float, y: float, config: PseudodrivelabConfig) -> bool:
    ...
    def _coords_to_pixel(self, coords):
        ...
        # Old : remove half in backward direction
        # New : include half in backward direction
...
class BoundingBox2DIndex(IntEnum):
    """Intenum for bounding boxes in Pseudolab."""
